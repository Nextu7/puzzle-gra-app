...
This app supports two tunnel solutions:

### Cloudflare Tunnel (Recommended for Production)

```powershell
# Quick setup with automated script
powershell -ExecutionPolicy Bypass -File scripts/setup-cloudflare-tunnel.ps1 -Domain "your-domain.com"

# Install as Windows service
scripts\install-cloudflare-service.bat  # Run as Administrator
```

**Benefits**: Stable URLs, no time limits, enterprise security, automatic SSL

**Domains created**:
- Production: `https://puzzle-gra.your-domain.com`
- Development: `https://dev-puzzle-gra.your-domain.com`  
- HMR: `https://hmr-puzzle-gra.your-domain.com`

📖 **Full setup guide**: See [CLOUDFLARE_SETUP.md](./CLOUDFLARE_SETUP.md)

### ngrok (Fallback for Quick Development)

```bash
# 1. Setup ngrok: https://ngrok.com/product/secure-tunnels
# 2. Create tunnel: ngrok http 3000
# 3. Copy forwarding address (e.g., https://abc123.ngrok-free.app)
# 4. Update .env:
